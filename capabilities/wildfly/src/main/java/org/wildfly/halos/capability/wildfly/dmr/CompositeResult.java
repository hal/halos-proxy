...
public class CompositeResult implements Iterable<ModelNode> {
    ...
    public CompositeResult(final ModelNode steps) {
     ...
     */
    public ModelNode step(final int index) {
     ...
     * @return the related step result
     */
    public ModelNode step(final String step) {
    ...
    public boolean isFailure() {
        return stream().anyMatch(ModelNodeHelper::isFailure);
    }
